...
Actualizado a Unreal Engine 5.7.4 (el motor tiene Quixel Bridge, Fab UE Plugin y otros plugins instalados pero que no están activados porque este proyecto no necesita ninguno) el 26 de marzo de 2026 (Curso académico 2025-2026). El error que me salió al modificar el proyecto fue: Failed to import 'D:/Epic Games/UE_5.7/FeaturePacks/StarterContent.upack'. Failed to create asset '/Game/StarterContent'... aunque entiendo que el contenido está ahí y no hay problemas. 
